# bot-base/logger/logger.py @ https://github.com/marcuscastelo/bot-base/commit/fede94f6271a722923b716eab7e2055ccb1bd7f2
...
class Logger:
    ...
    def _log(self, message: Message, initial_stack_trace: str = ''):
        ...
        # if message.level in [MessageLevel.ERROR, MessageLevel.WARNING, MessageLevel.DEBUG]:
